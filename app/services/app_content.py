...
DEFAULTS: dict[str, dict[str, dict]] = {
    "ro": {
        ...
        "account_detail": {
            ...
            "checked_at": "Ultima verificare: {date}",
            "history_title": "Istoric verificări",
            "history_empty": "Fără istoric de verificări.",
            "history_paid": "Plătită",
            "history_unpaid": "Neplătită",
            "history_unknown": "Necunoscută",
            "history_cancelled": "Anulată",
            "error_history": "Istoricul nu a putut fi încărcat.",
        },
        "home_form": {
        ...
        "profile": {
            ...
            "logout": "Deconectare",
            "check_update": "Verifică actualizări",
            "check_update_sub": "Descarcă ultima versiune Android",
            "check_update_none": "Ai deja ultima versiune.",
        },
    },
    "ru": {
        "common": {
        ...
        "invoices": {
            ...
            "disable": "Отключить",
            "enable": "Включить",
            "filter_title": "Фильтры счетов",
            "f_status": "Статус",
            "f_all": "Все",
            "f_unpaid": "Неоплаченные",
            "f_paid": "Оплаченные",
            "f_utility": "Услуга",
            "f_home": "Жильё",
            "f_contract": "Договор (поиск)",
            "f_apply": "Применить",
            "f_reset": "Убрать фильтр",
        ...
        "account_detail": {
            ...
            "checked_at": "Последняя проверка: {date}",
            "history_title": "История проверок",
            "history_empty": "Истории проверок нет.",
            "history_paid": "Оплачено",
            "history_unpaid": "Не оплачено",
            "history_unknown": "Неизвестно",
            "history_cancelled": "Отменён",
            "error_history": "Не удалось загрузить историю.",
        },
        "home_form": {
        ...
        "profile": {
            ...
            "check_update_sub": "Скачать последнюю Android версию",
            "check_update_none": "У вас уже последняя версия.",
        },
    },
    "en": {
        "common": {
        ...
        "invoices": {
            ...
            "f_utility": "Utility",
            "f_home": "Home",
            "f_contract": "Contract (search)",
            "f_apply": "Apply",
            "f_reset": "Clear filter",
        ...
        "account_detail": {
            ...
            "history_empty": "No check history.",
            "history_paid": "Paid",
            "history_unpaid": "Unpaid",
            "history_unknown": "Unknown",
            "history_cancelled": "Cancelled",
            "error_history": "Could not load history.",
        },
        "home_form": {
            "title_new": "New home",
        ...
        "profile": {
            ...
            "check_update_sub": "Download the latest Android version",
            "check_update_none": "You already have the latest version.",
        },
    },
}
...
FIELDS: dict[str, list[tuple[str, str, str]]] = {
    "dashboard": [
        ...
        ("vezi", "text", "„vezi”"),
        ("support_enabled", "checkbox", "Buton activ (susținere)"),
    ...
    "homes": [
        ...
        ("paid_chip", "text", "Chip achitate ({count})"),
        ("empty", "text", "Text gol"),
        ("fab_home", "text", "Meniu FAB: Locuință"),
        ("fab_utility", "text", "Meniu FAB: Utilitate"),
        ("error_load", "text", "Eroare la încărcare"),
    ...
    "invoices": [
        ...
        ("checked_at", "text", "Verificat ({value})"),
        ("paid", "text", "Status plătită"),
        ("unpaid", "text", "Status neplătită"),
        ("cancelled", "text", "Status anulată"),
        ("mark_paid", "text", "Buton marchează achitată"),
        ("disable", "text", "Buton dezactivează"),
        ("enable", "text", "Buton activează"),
        ("filter_title", "text", "Titlu filtre"),
        ("f_status", "text", "Filtru status"),
        ("f_all", "text", "Filtru toate"),
        ("f_unpaid", "text", "Filtru neachitate"),
        ("f_paid", "text", "Filtru achitate"),
        ("f_utility", "text", "Filtru utilitate"),
        ("f_home", "text", "Filtru locuință"),
        ("f_contract", "text", "Filtru contract"),
        ("f_apply", "text", "Buton aplică"),
        ("f_reset", "text", "Buton șterge filtrul"),
        ("empty", "text", "Text gol"),
        ("error_load", "text", "Eroare la încărcare"),
    ...
    "account_detail": [
        ...
        ("status_cancelled", "text", "Status anulată"),
        ("checked_at", "text", "Ultima verificare ({date})"),
        ("history_title", "text", "Titlu istoric"),
        ("history_empty", "text", "Istoric gol"),
        ("history_paid", "text", "Istoric plătită"),
        ("history_unpaid", "text", "Istoric neplătită"),
        ("history_unknown", "text", "Istoric necunoscută"),
        ("history_cancelled", "text", "Istoric anulată"),
        ("status_cancelled", "text", "Status anulată"),
        ("empty", "text", "Text gol"),
    ...
    "profile": [
        ...
        ("check_update", "text", "Verifică actualizări"),
        ("check_update_sub", "text", "Subtitlu verificare actualizări"),
        ("check_update_none", "text", "Nicio actualizare disponibilă"),
    ],
}
...
FIELD_SECTIONS: dict[str, list[tuple[str, tuple[str, ...] | None]]] = {
    ...
    "account_detail": [
        ("Informații și status", ("contract", "location", "refresh", "edit",
                                  ...
                                  "status_unknown", "status_cancelled", "empty")),
        ("Istoric verificări", ("checked_at", "history_title", "history_empty",
                                "history_paid", "history_unpaid", "history_unknown",
                                "history_cancelled")),
        ("Erori și sfaturi", None),
    ],
    "invoices": [
        ("General", ("group_others", "default_title", "period", "due", "checked_at",
                     "paid", "unpaid", "cancelled", "mark_paid", "disable", "enable",
                     "empty", "error_load")),
        ("Filtre", ("filter_title", "f_status", "f_all", "f_unpaid", "f_paid",
                    "f_utility", "f_home", "f_contract", "f_apply", "f_reset")),

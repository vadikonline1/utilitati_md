...
release publicat, se propune descărcarea noului APK (Managerul de actualizări
apare în **Profil → „Verifică actualizări"**). Pe iOS nu se face nicio verificare
(update-ul circulă prin App Store).
